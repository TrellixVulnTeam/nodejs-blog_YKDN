...
var best_seller_right_button = document.querySelector(
    '.best-seller__button-right',
);
var best_seller_left_button = document.querySelector(
    '.best-seller__button-left',
);
